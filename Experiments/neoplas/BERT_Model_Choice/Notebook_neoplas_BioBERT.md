...
```
    ...
    Epoch [10/1000], Training Loss: 0.0023159882985055447
...
![png](output_36_1.png)
    ...
    Training complete! Total training time: 1802.64 seconds
...
```
    ...
    Epoch [1/100] Training Loss: 0.4821, F1 Score: 0.0219 | Validation Loss: 0.2157, F1 Score: 0.0000
...
![png](output_44_1.png)
    ...
    Training complete! Total time: 1419.10 seconds
...
```
    ...
    Number of Positive predictions: 2345
...
```
    ...
    Number of Correct Predictions: 1743
