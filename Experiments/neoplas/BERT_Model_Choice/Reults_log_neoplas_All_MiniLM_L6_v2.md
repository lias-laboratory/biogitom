...
```
    ...
    Epoch [10/1000], Training Loss: 0.25010964274406433
...
![png](output_36_1.png)
    ...
    Training complete! Total training time: 551.29 seconds
...
```
    ...
    Epoch [1/100] Training Loss: 0.5489, F1 Score: 0.0211 | Validation Loss: 0.3181, F1 Score: 0.4298
...
![png](output_44_1.png)
    ...
    Training complete! Total time: 1216.49 seconds
...
```
    ...
    Number of Positive predictions: 2427
...
```
    ...
    Number of Correct Predictions: 1713
