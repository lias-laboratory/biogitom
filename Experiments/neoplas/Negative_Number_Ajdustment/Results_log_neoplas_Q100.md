...
```
    ...
    ✅ After removing train-only URIs: 93924 rows
    ✅ After keeping only test SrcEntities: 22297 rows
    ✅ After applying threshold ≥ 0.0: 22297 rows
    ...
    🏆 Selected candidates within 99.2% of best score per SrcEntity: 2516 rows
    ...
    📊 Evaluation (P / R / F1): {'P': 0.762, 'R': 0.719, 'F1': 0.74}
