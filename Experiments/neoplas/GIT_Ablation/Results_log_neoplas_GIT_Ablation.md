...
```
    ...
    Epoch [10/1000], Training Loss: 0.0016710218042135239
...
![png](output_36_1.png)
    ...
    Training complete! Total training time: 1715.87 seconds
...
```
    ...
    Epoch [1/100] Training Loss: 0.2516, F1 Score: 0.0178 | Validation Loss: 0.1403, F1 Score: 0.0000
...
![png](output_44_1.png)
    ...
    Training complete! Total time: 3602.06 seconds
...
```
    ...
    Number of Positive Predictions : 1935
...
```
    ...
    Number of Correct Predictions : 1542
