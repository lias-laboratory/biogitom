...
```
    ...
    Epoch [10/1000], Training Loss: 0.2252236157655716
...
![png](output_36_1.png)
    ...
    Training complete! Total training time: 551.36 seconds
...
```
    ...
    Epoch [1/100] Training Loss: 0.4946, F1 Score: 0.0249 | Validation Loss: 0.2697, F1 Score: 0.5808
...
![png](output_44_1.png)
    ...
    Training complete! Total time: 1513.97 seconds
...
```
    ...
    Number of Positive predictions: 3226
...
```
    ...
    Number of Correct Predictions: 2838
