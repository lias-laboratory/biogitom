...
```
    ...
    Epoch [10/1000], Training Loss: 0.2257397472858429
...
![png](output_54_1.png)
    ...
    Training complete! Total training time: 285.49 seconds
...
```
    ...
    Epoch [1/100] Training Loss: 0.4260, F1 Score: 0.1013 | Validation Loss: 0.2123, F1 Score: 0.0000
...
![png](output_61_1.png)
    ...
    Training complete! Total time: 481.75 seconds
...
```
    ...
    📁 Top-1 file saved: /content/gdrive/My Drive/BioGITOM-VLDB//ncit2doid/Results/ncit2doid_top_10_mappings_All_Mini_predictions.tsv
...
```
    ...
    📁 Top-1 file saved: /content/gdrive/My Drive/BioGITOM-VLDB//ncit2doid/Results/ncit2doid_top_1_mappings_All_Mini_predictions.tsv
...
merged_tgt_df.to_csv(f"{data_dir}/{tgt_ent}_cands_with_embeddings_All_Mini.tsv", sep="\t", index=False)
```
