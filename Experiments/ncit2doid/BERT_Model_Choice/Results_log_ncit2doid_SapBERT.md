...
```
    ...
    Epoch [10/1000], Training Loss: 0.0019168693106621504
...
![png](output_36_1.png)
    ...
    Training complete! Total training time: 1066.45 seconds
...
```
    ...
    Epoch [1/100] Training Loss: 0.4498, F1 Score: 0.0263 | Validation Loss: 0.2686, F1 Score: 0.5191
...
![png](output_44_1.png)
    ...
    Training complete! Total time: 1721.20 seconds
...
```
    ...
    Number of Correct Predictions: 2859
