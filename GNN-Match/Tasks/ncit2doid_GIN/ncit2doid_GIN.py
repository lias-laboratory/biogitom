...
# ======================================================
#  GIN Architecture (remplace RGIT / GIT par un GIN simple)
# ======================================================
...
# Initialize the GIN_mod model with the dimensionality of the target embeddings
GIN_model = GIN_mod(dim_h=x_tgt.shape[1], num_layers=2, num_linear_layers=1, dropout=0.0)
...
trained_model = train_model_gnn(
    model=GIN_model,                # The GNN model to be trained (initialized earlier)
...
# Move the trained GIN model to the device (GPU or CPU)
