...
src_ent = "snomed.pharm"        # SNOMED CT pharmaceutical concepts
tgt_ent = "ncit.pharm"          # NCIT pharmaceutical concepts

# Define the matching task name
task = "pharm"                  # Used to name intermediate and output files

# Set the value of top-k candidates to consider 
k = 3

# Score margin used for relaxed top-1 selection
score_margin = 0.003            # Minimum score difference required between top-1 and runner-up
